        ...
        <div>
            <section className="min-h-[80vh] bg-[#fdfaf5] px-6 py-20 font-fauna">
                ...
                <div className="mx-auto max-w-3xl text-center">
                    ...
                    <p className="mb-3 text-sm uppercase tracking-[0.3em] text-[#816c4d]">
                        Membership Plans
                    </p>

                    <h1 className="font-cinzel text-4xl font-bold text-[#1B2F4F] md:text-5xl">
                        Choose Your Study Experience
                    </h1>

                    <p className="mt-6 text-lg leading-8 text-gray-600">
                        Unlock peaceful study spaces, premium features,
                        and a better way to stay productive with Nestudy.
                    </p>
                </div>
                ...
                <div className="mx-auto mt-16 grid max-w-7xl gap-8 md:grid-cols-3">
                    ...
                    {plans.map((plan, index) => (
                        <Card
                            key={index}
                            className={`relative rounded-2xl border shadow-md transition duration-300 hover:-translate-y-2 hover:shadow-2xl ${plan.popular
                                ? "border-[#816c4d] bg-white"
                            ...
                            <div className="p-8">
                                ...
                                {/* Icon */}
                                <div className="mb-5 flex h-14 w-14 items-center justify-center rounded-full bg-[#816c4d]/10 text-2xl text-[#816c4d]">
                                    {plan.icon}
                                </div>
                                ...
                                <div className="mt-4 flex items-end gap-1">
                                    <h3 className="text-5xl font-bold text-[#1B2F4F]">
                                        {plan.price}
                                    </h3>
                                ...
                                <Button
                                    size="lg"
                                    className={`mt-10 w-full rounded-md font-medium ${plan.popular
