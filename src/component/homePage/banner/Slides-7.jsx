...
import hero from "@/assets/Hero-7.webp"
        ...
        <div
            ...
            <div className="relative z-10 max-w-2xl px-6 text-center text-white animate__animated animate__fadeIn">
                ...
                <p className="mb-6 text-lg text-gray-200 font-fauna">
                    Find quiet study rooms in libraries and learning spaces around you. Reserve instantly or list your own room for others.
                </p>
                <Button
                    size="lg"
